<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="organizadores_id" class="form-control @error('organizadores_id') is-invalid @enderror" value="{{ old('organizadores_id', $participacione?->organizadores_id) }}" id="organizadores_id" placeholder="Organizadores Id">
